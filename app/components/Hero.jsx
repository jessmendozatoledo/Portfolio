            ...
            <div className="max-w-4xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        ...
                        {/* Facebook */}
                        <a
                            href={resumeData.contact.social.facebook}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-3 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-400 hover:text-primary hover:border-primary/50 hover:bg-zinc-800/80 transition-all duration-300 hover:-translate-y-1"
                            aria-label="Facebook"
                        ...
                        {/* Instagram */}
                        <a
                            href={resumeData.contact.social.instagram}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-3 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-400 hover:text-primary hover:border-primary/50 hover:bg-zinc-800/80 transition-all duration-300 hover:-translate-y-1"
                        ...
                        {/* TikTok */}
                        <a
                            href={resumeData.contact.social.tiktok}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-3 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-400 hover:text-primary hover:border-primary/50 hover:bg-zinc-800/80 transition-all duration-300 hover:-translate-y-1"
                            aria-label="TikTok"
                        ...
                        <a
                            ...
                            aria-label="Phone"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.16 6.16l1.27-.88a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                        </a>
                    </div>
                </div>
