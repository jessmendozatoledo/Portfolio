                                    ...
                                    >
                                        ...
                                        <div className="flex flex-wrap gap-1.5 md:gap-2">
                                            {skillGroup.items.map((skill, i) => (
                                                <span
                                                    key={i}
                                                    className="bg-blue-100/80 dark:bg-blue-500/50 text-zinc-800 dark:text-zinc-300 text-[9px] md:text-[11px] px-1.5 py-0.5 md:px-2 md:py-1 rounded-md border border-blue-300/60 dark:border-blue-700/30"
                                                >
                                                    {skill}
                                                </span>
                                            ))}
